...
\begin{table}[htbp]
  ...
  \begin{tabular}{ccccccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption{Iteration count for the anistropic 2D Poisson problem ($\epsilon = 100$, $\theta = \frac{\pi}{6}$) varying number of processes $n_p$ and number of refinement levels.\label{tab:anisopoisson2D}}
