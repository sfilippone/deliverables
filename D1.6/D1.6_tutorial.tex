...
SISSA on Dec. 11th and 12th, 2025.
...
\subsection{Include files and setup}
In addition to classical deal.II include files, the tutorial program includes the headers
files \texttt{psctoolkit\_wrappers.h}, which contains the needed declarations common to all
